const Images = {
    ...
    feature_3: require('./homePage/feature/feature-icon-3.gif'),
    feature_4: require('./homePage/feature/feature-icon-4.gif'),
    feature_5: require('./homePage/feature/feature-icon-5.gif'),
    feature_6: require('./homePage/feature/feature-icon-6.gif'),
    mask: require('./homePage/mask.svg'),
    phone_with_hand: require('./homePage/phone_with_hand.jpeg'),

    // carousel
    carousel_1: require('./homePage/carousel/carousel-1.jpg'),
