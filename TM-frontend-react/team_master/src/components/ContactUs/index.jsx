          ...
          <div class="row">
              ...
              <h1>
                <div class="about-icons">
                  <ul>
                    ...
                    <li>
                      {" "}
                      <a href="mailto:teammasterlk@gmail.com">
                        <i
                          id="social-em"
            ...
            <div class="col-md-7 col-sm-6">
              <div class="about-title clearfix">
                <h1>
                  About <span>TeamMaster</span>
                </h1>
                <h3 className="font-weight-light">
                  All in one project / team management platform{" "}
                </h3>
                <p class="about-paddingB">
                  TeamMaster provides all kind of team engagement activities
                  inside one single platform. We provide you to form projects
                  and teams with your team mates and you will be able to manage
                  a project management workspace / storyboard (kanban) and you
                  will be able to use chat room service to chat with the same
                  particular team and also we provide video conferencing
                  facility for your particular team to have your online meetings
                  in a secure manner.
                </p>
                <p>
                  We are a group of Software Engineers from University of
                  Kelaniya Sri Lanka, behind the success of this amazing
                  platform
                </p>
